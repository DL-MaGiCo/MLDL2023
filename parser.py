...
def parse_arguments():
    ...
    # Paths parameters
    parser.add_argument("--train_path", type=str, default="/content/gsv_xs/train",
                        help="path to train set")
    parser.add_argument("--val_path", type=str, default="/content/sf_xs/val",
                        help="path to val set (must contain database and queries)")
    parser.add_argument("--test_path", type=str, default="/content/sf_xs/test",
                        help="path to test set (must contain database and queries)")

 
    
    parser.add_argument("--exp_name", type=str, default="default",
                        help="exp name", choices = ['default', 'gem', 'mix'])
    parser.add_argument("--loss", type=str, default="default",
                        help="type loss", choices = ['default', 'multisim', 'fast'])
    parser.add_argument("--optim", type=str, default='sgd',
                        help="type optimizer", choices = ['sgd', 'adamw'])
